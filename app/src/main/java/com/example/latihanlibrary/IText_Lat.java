...
public class IText_Lat extends AppCompatActivity {

    private static final String TAG = "IText_LatActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contentET = findViewById (R.id.edit_text_content);
        ...
        btnCreate.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick(View view) {
                ...
                if (contentET.getText ().toString ().isEmpty ()) {
                    contentET.setError ("Isi tulisan terlebih dahulu !");
    ...
    private void createPdf() throws FileNotFoundException, DocumentException {
        ...
        document.open ();
        document.add (new Paragraph (contentET.getText ().toString ()));
        document.close ();
        previewPdf ();
    }
    ...
    private void previewPdf() {
        ...
        if (list.size () > 0) {
            ...
            Uri uri = FileProvider.getUriForFile(this, "com.example.latihanlibrary.fileprovider", pdfFile);
